...
-- Contraseña encriptada para Admin123!: $2a$10$eD4W2u9E7UjH.zT6xJ7P/.3K8x2Zq4sA8/4bN5C2mL7P9R1Q0S6e
INSERT INTO tbl_users (username, email, password_hash, status, created_at, updated_at, created_by, updated_by)
VALUES ('admin', 'admin@buyio.com', '$2a$10$eD4W2u9E7UjH.zT6xJ7P/.3K8x2Zq4sA8/4bN5C2mL7P9R1Q0S6e', 'ACTIVE', NOW(), NOW(), 'SYSTEM', 'SYSTEM')
ON CONFLICT (username) DO NOTHING;

INSERT INTO tbl_users (username, email, password_hash, status, created_at, updated_at, created_by, updated_by)
VALUES ('operator', 'operator@buyio.com', '$2a$10$eD4W2u9E7UjH.zT6xJ7P/.3K8x2Zq4sA8/4bN5C2mL7P9R1Q0S6e', 'ACTIVE', NOW(), NOW(), 'SYSTEM', 'SYSTEM')
ON CONFLICT (username) DO NOTHING;
